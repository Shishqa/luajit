...
static event_handler event_handlers[] = {
    write_native,      /* LJ_VMST_INTERP */
    write_full_info, /* LJ_VMST_LFUNC */
    write_full_info, /* LJ_VMST_FFUNC */
    write_full_info, /* LJ_VMST_CFUNC */
    write_native,      /* LJ_VMST_GC */
    write_native,      /* LJ_VMST_EXIT */
    write_native,      /* LJ_VMST_RECORD */
    write_native,      /* LJ_VMST_OPT */
    write_native,      /* LJ_VMST_ASM */
    write_native     /* TRACE */
};
